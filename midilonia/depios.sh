...
#codesign --deep --force --verbose --sign "Apple Development: Shane Morrison (EE6F6TUKRZ)" midilonia.iOS/bin/Debug/net8.0-ios/ios-arm64/midilonia.iOS.app

#check signature
#codesign -dv --verbose=4 midilonia.iOS/bin/Debug/net8.0-ios/ios-arm64/midilonia.iOS.app
